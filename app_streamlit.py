...
st.markdown(
    '<div style="border:2px solid #2546ff;background:linear-gradient(90deg,#1a1a2e 60%,#16213e 100%);border-radius:16px;padding:28px 24px 22px 24px;margin-bottom:32px;box-shadow:0 4px 24px 0 rgba(36,99,235,0.12),0 0 0 2px #2546ff33;color:#e0e6f7;position:relative;overflow:hidden;">\n'
...
with st.form("salary_form"):
    ...
    if submitted:
        if "Select" in [job_title, location, nationality, gender, education, marital_status]:
            ...
            st.success(f"Predicted Salary: ₹{prediction[0]:,.0f} lakhs")
